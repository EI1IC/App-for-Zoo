...
namespace RazorPagesZoo.Migrations
{
    ...
    [Migration("20250113193617_identityJournal")]
    partial class identityJournal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CageAnimal", b =>
                {
                    ...
                    b.HasKey("IdCage", "IdAnimal")
                        .HasName("cage_cage_animalpk");

                    b.HasIndex("IdAnimal");

                    b.ToTable("cage_animal", "zoo_keepers");
                });
            ...
            modelBuilder.Entity("RazorPagesZoo.Models.Compatibility", b =>
                {
                    b.Property<int>("IdSpecies1")
                        .HasColumnType("integer")
                        .HasColumnName("id_species_1");

                    b.Property<int>("IdSpecies2")
                        .HasColumnType("integer")
                        .HasColumnName("id_species_2");

                    b.Property<int>("IdCage")
                        .HasColumnType("integer")
                        .HasColumnName("id_cage");

                    b.HasKey("IdSpecies1", "IdSpecies2", "IdCage")
                        .HasName("compatibilitypk");

                    b.HasIndex("IdCage");

                    b.HasIndex("IdSpecies2");

                    b.ToTable("compatibility", "zoo_keepers");
                });
            ...
            modelBuilder.Entity("RazorPagesZoo.Models.Post", b =>
                {
                    b.Property<int>("ID_Post")
                        .HasColumnType("integer")
                        .HasColumnName("id_post");
                    ...
                    b.HasKey("ID_Post")
                        .HasName("id_post_pkey");

                    b.ToTable("post", "zoo_keepers");
                });
            ...
            modelBuilder.Entity("RazorPagesZoo.Models.Vaccination", b =>
                {
                    ...
                    b.Property<DateOnly>("DateLastVaccination")
                        .HasColumnType("date")
                        .HasColumnName("date_last_vacciantion");
            ...
            modelBuilder.Entity("CageAnimal", b =>
                {
                    b.HasOne("RazorPagesZoo.Models.Animal", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("cage_animalfk");

                    b.HasOne("RazorPagesZoo.Models.Cage", null)
                        .WithMany()
                        .HasForeignKey("IdCage")
                        .IsRequired()
                        .HasConstraintName("cage_cagefk");
                });
            ...
            modelBuilder.Entity("RazorPagesZoo.Models.Compatibility", b =>
                {
                    b.HasOne("RazorPagesZoo.Models.Cage", "IdCageNavigation")
                        ...
                        .HasForeignKey("IdCage")
                        .IsRequired()
                        .HasConstraintName("compatibility_cagefk");

                    b.HasOne("RazorPagesZoo.Models.SpeciesNote", "IdSpecies1Navigation")
                        .WithMany("CompatibilityIdSpecies1Navigations")
                        .HasForeignKey("IdSpecies1")
                        .IsRequired()
                        .HasConstraintName("compatibility_id1fk");

                    b.HasOne("RazorPagesZoo.Models.SpeciesNote", "IdSpecies2Navigation")
                        .WithMany("CompatibilityIdSpecies2Navigations")
                        .HasForeignKey("IdSpecies2")
                        .IsRequired()
                        .HasConstraintName("compatibility_id2fk");

                    b.Navigation("IdCageNavigation");

                    b.Navigation("IdSpecies1Navigation");

                    b.Navigation("IdSpecies2Navigation");
                });

            modelBuilder.Entity("RazorPagesZoo.Models.Employee", b =>
                {
                    b.HasOne("RazorPagesZoo.Models.Post", "PostNavigation")
                        .WithMany("Employees")
                        .HasForeignKey("ID_Post")
                        .IsRequired()
                        .HasConstraintName("employee_postfk");
            ...
            modelBuilder.Entity("RazorPagesZoo.Models.SpeciesNote", b =>
                {
                    ...
                    b.Navigation("CompatibilityIdSpecies1Navigations");

                    b.Navigation("CompatibilityIdSpecies2Navigations");
                });
